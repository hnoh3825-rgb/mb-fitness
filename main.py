...
with st.sidebar:
    ...
    # 🎥 خيار تحديد جنس المدرب في الفيديوهات
    st.markdown("""
    <div class="sidebar-card">
        <div class="sidebar-card-title">🎥 تخصيص عارض الفيديوهات</div>
    """, unsafe_allow_html=True)
    video_presenter = st.radio("اختر أداء الفيديوهات:", ["رجال 👨‍🦰", "نساء 👩‍🦰"], index=0)
...
# ==================== حالة التنقل بين الأقسام (الافتراضي: التمارين workouts) ====================
...
# ==================== 1. قسم التمارين (يتكيف حسب اختيار المستخدم: رجال أو نساء) ====================
    ...
    if "رجال" in video_presenter:
        crossfit_data = {
            "تمارين حرق وقوة (Bodyweight 🔥)": [
                {"title": "تمرين البيربيز الشامل", "english_name": "Burpees", "sets": "3 جلسات", "reps": "12 تكرار", "desc": "تمرين كروس فيت متكامل يرفع معدل ضربات القلب ويضاعف حرق السعرات بكفاءة عالية.", "url": "https://www.youtube.com/watch?v=lCUCNVs0ibM"},
                {"title": "تمرين القفز المتوافق", "english_name": "Jumping Jacks", "sets": "3 جلسات", "reps": "45 ثانية", "desc": "إحماء ممتاز لتنشيط الدورة الدموية ورفع كفاءة الجهاز التنفسي.", "url": "https://www.youtube.com/watch?v=iFF0asehVFY"},
                {"title": "تمرين تسلق الجبل", "english_name": "Mountain Climbers", "sets": "3 جلسات", "reps": "20 تكرار لكل رجل", "desc": "يركز على تقوية عضلات الجذع والبطن ورفع اللياقة الهوائية.", "url": "https://www.youtube.com/watch?v=cnyTQDSE888"}
            ],
            "تمارين الجزء السفلي والكتلة (Legs & Core 🦵)": [
                {"title": "تمرين السكوات التفجيري", "english_name": "Jump Squats", "sets": "4 جلسات", "reps": "15 تكرار", "desc": "يقوي عضلات الفخذين والأرداف ويزيد القوة الانفجارية للقدمين.", "url": "https://www.youtube.com/watch?v=Azvwoh8UZh0"},
                {"title": "تمرين الطعن الثابت والمتبادل", "english_name": "Lunges", "sets": "3 جلسات", "reps": "12 تكرار لكل رجل", "desc": "يحسن التوازن والثبات الحركي ويقوي عضلات الساقين.", "url": "https://www.youtube.com/watch?v=D7KaRcUTQeE"}
            ],
        ...
        crossfit_data = {
            "تمارين حرق وقوة (Bodyweight 🔥)": [
                {"title": "تمرين البيربيز الشامل", "english_name": "Burpees", "sets": "3 جلسات", "reps": "12 تكرار", "desc": "تمرين كروس فيت متكامل يرفع معدل ضربات القلب ويضاعف حرق السعرات بكفاءة عالية.", "url": "https://www.youtube.com/watch?v=dZgVxmf6jkA"},
